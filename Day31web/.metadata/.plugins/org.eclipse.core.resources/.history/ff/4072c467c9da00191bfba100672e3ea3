...
public class HelloServiceLocator extends org.apache.axis.client.Service implements helloservice.endpoint.HelloService {
    ...
    private java.lang.String HelloPort_address = "http://127.168.1.107:8181/Hello";
    ...
    public helloservice.endpoint.Hello getHelloPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            helloservice.endpoint.HelloPortBindingStub _stub = new helloservice.endpoint.HelloPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (helloservice.endpoint.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                helloservice.endpoint.HelloPortBindingStub _stub = new helloservice.endpoint.HelloPortBindingStub(new java.net.URL(HelloPort_address), this);
                _stub.setPortName(getHelloPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://endpoint.helloservice/", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://endpoint.helloservice/", "HelloPort"));
        }
