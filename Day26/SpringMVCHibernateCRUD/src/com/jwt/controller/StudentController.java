...
public class StudentController {
	...
	public ModelAndView listStudent(ModelAndView model) throws IOException {
		logger.debug(new Date()+ " " + this.getClass()+ "listStudent" + "Entering Into");
		logger.debug(new Date()+ " " + this.getClass()+ "listStudent" + "Calling Student Service");
		List<Student> listStudent = StudentService.getAllStudents();
		logger.debug(new Date()+ " " + this.getClass()+ "listStudent" + "Student Service calling completed");
	...
	public ModelAndView saveStudent(@ModelAttribute Student Student) {
		if (Student.getRollNum() == 0) { // if Student RollNum is 0 then creating the
